...
<AccordionGroup>
  ...
  <Accordion title="How many skills can I install?">
    There's no limit. Install as many skills as you want from the marketplace. Your agent can also learn additional skills on its own.
  </Accordion>

  <Accordion title="What channels are coming next?">
    Discord, WhatsApp, and Slack are in development. Follow us on [X](https://x.com/useklaws) for updates.
  </Accordion>
</AccordionGroup>
